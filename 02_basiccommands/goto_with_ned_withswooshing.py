...
def setNED(currentLocation,targetLocation):
    ...
    ned.north = ned.north*scaling_factor
    ned.east = ned.east*scaling_factor
    return ned
...
while angle <= 360:
    ...
    while distance_to_target > .5:
        ...
        print ("Distance to target: " + str(distance_to_target) + "  NED: " + str(ned.north) + " " + str(ned.east) + " " + str(ned.down) + "\n")
        ned = setNED(currentLocation, nextTarget)
        send_ned_velocity(ned.north,ned.east,ned.down,10)
        #lon_array[-1]
